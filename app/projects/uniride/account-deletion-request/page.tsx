...
export default function AccountDeletionRequestPage() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    if (!confirm)
      return setError('Please confirm that you want to delete your account.');
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto mt-16 max-w-3xl px-6 py-24">
        <div className="mb-8">
          <h1 className="mb-2 text-4xl font-bold text-[#333333]">
            Account Deletion Request
          </h1>
          <p className="text-[#333333]/80">
            Submit a request to permanently delete your UniRide account. We'll
            verify and respond via email.
          </p>
        </div>
        ...
        >
          ...
          <div className="flex items-start space-x-3">
            ...
            <label htmlFor="confirm" className="text-sm text-gray-700">
              I confirm I want to permanently delete my UniRide account. I
          ...
          {success && (
            <div className="rounded-md border-l-4 border-green-500 bg-green-50 p-4 text-green-700">
              {success}
            </div>
          )}
        ...
        <div className="mt-8 text-sm text-gray-600">
          <p>
            Note: For security we may ask for additional verification before
            processing your request. If you have concerns, contact us at{' '}
            <a href="mailto:asteriskshq@gmail.com" className="text-[#1DA1F2]">
