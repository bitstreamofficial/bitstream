        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-100">
              ...
              <Link href="/projects/uniride/privacy-policy" className="text-gray-600 hover:text-blue-600 block px-3 py-2 rounded-md text-base font-medium">
                Privacy Policy
              </Link>
              <Link href="/projects/uniride/terms-of-service" className="text-gray-600 hover:text-blue-600 block px-3 py-2 rounded-md text-base font-medium">
                Terms of Service
              </Link>
              <button className="w-full text-left bg-gradient-to-r from-blue-600 to-purple-600 text-white px-3 py-2 rounded-md text-base font-medium">
                Get Started
              </button>
            </div>
          </div>
