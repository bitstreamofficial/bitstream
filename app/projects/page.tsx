            ...
            >
              ...
              >
                ...
                <div className="relative z-10 p-6">
                  ...
                  <button
                    className={`
                    w-full transform rounded-xl bg-gradient-to-r py-3 font-semibold transition-all
                    duration-300 ${project.gradient} text-white
                    hover:scale-105 hover:shadow-lg hover:shadow-black/20
                    ${hoveredProject === index ? 'scale-105 shadow-lg' : ''}
                  `}
                  >
                    View Details
                    <svg
